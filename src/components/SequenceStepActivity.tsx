...
const tableData = [
  {
    ...
    subjectIconColor: 'text-[#60b6d1]',
    subjectIconBg: 'bg-[#d8eff5] dark:bg-[#60b6d1]/20',
  ...
  },
  {
    subject: 'Copywriter',
    subjectIcon: PenTool,
    subjectIconColor: 'text-[#b062eb]',
    subjectIconBg: 'bg-[#f1e0fc] dark:bg-[#b062eb]/20',
    senderName: 'Anthony beane',
    sent: 19,
    sentPercentage: 83,
    opened: 9,
...
export default function SequenceStepActivity() {
  return (
    <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden flex flex-col transition-colors">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          <thead className="text-gray-400 dark:text-gray-500 font-medium">
            <tr>
              <th className="px-5 py-3 font-normal">Subject</th>
              <th className="px-5 py-3 font-normal">Sender</th>
              <th className="px-5 py-3 font-normal text-right">Sent</th>
              <th className="px-5 py-3 font-normal text-right">Opened</th>
              <th className="px-5 py-3 font-normal text-right">Replied</th>
              <th className="px-5 py-3 font-normal text-right">Scheduled</th>
            </tr>
          </thead>
          <tbody className="text-gray-600 dark:text-gray-400">
            {tableData.map((row, index) => (
              <tr key={index} className="border-t border-gray-100 dark:border-gray-800/50 hover:bg-gray-50/50 dark:hover:bg-gray-900/50 transition-colors">
